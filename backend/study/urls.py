...
from .views import LearnView, ReadingView, AuditionView, SyntaxView, ChatbotView, PersonalCabView, DialoView, STTView, TTSView
...
urlpatterns = [
    ...
    path('dialo/', DialoView.as_view(), name='dialo'),
